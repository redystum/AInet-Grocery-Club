...
<x-main>
    ...
    <div class="bg-gradient-to-r from-green-600 to-emerald-600 p-6 text-white text-center relative">
        ...
        <h1 class="text-2xl font-bold">Your Order Has Been Placed!</h1>
        <p class="opacity-90 mt-1">Order #@{{ $orderId }} is being processed</p>
    </div>

    <div class="p-6">
        <!-- Stock Delay Warning -->
        @if($delayed)
            <div class="bg-yellow-50 dark:bg-yellow-900/30 border-l-4 border-yellow-500 p-4 mb-6 rounded-r-lg">
                <div class="flex">
                    <div class="flex-shrink-0 text-yellow-500 dark:text-yellow-400">
                        <i class="fas fa-exclamation-circle fa-lg"></i>
                    </div>
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-yellow-700 dark:text-yellow-300">
        ...
        <div class="flex items-center mb-6">
            ...
            <div>
                ...
                <p class="text-neutral-600 dark:text-neutral-400">Thank you for your order! We're preparing your items for shipment.</p>
            </div>
        </div>
