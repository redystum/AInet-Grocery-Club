...
<head>
  ...
  <title>Cancellation Request Denied</title>
  <style>
...
<body class="dark-bg-neutral-900" style="background-color: #f5f5f5; font-family: ui-sans-serif, system-ui, -apple-system, 'Segoe UI', sans-serif">
  <div class="dark-bg-neutral-800" style="margin: 32px auto; max-width: 576px; overflow: hidden; border-radius: 12px; background-color: #fffffe; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05)">
    ...
    <!-- Header with Logo -->
    <div class="from-amber-600 to-yellow-600" style="position: relative; background-image: undefined; padding: 24px; text-align: center; color: #fffffe">
      <div style="margin-bottom: 16px; display: flex; justify-content: center">
        <img src="{{ $logoUrl }}" alt="{{ $appName }} Logo" style="height: 40px" height="40">
      </div>
      <h1 style="font-size: 24px; font-weight: 700">Cancellation Request Not Approved</h1>
      <p style="margin-top: 4px; opacity: 0.9">Your request to cancel order #{{ $orderId }} was not approved</p>
    </div>

    <div style="padding: 24px">
      <!-- User Greeting -->
      <div style="margin-bottom: 24px; display: flex; align-items: center">
        <div class="from-amber-500 to-yellow-500" style="margin-right: 16px; height: 64px; width: 64px; overflow: hidden; border-radius: 9999px; background-image: undefined; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1)">
        ...
        <div>
          ...
          <p class="dark-text-neutral-400" style="color: #525252">We've reviewed your cancellation request</p>
        </div>
      </div>

      <!-- Status Alert -->
      <div class="dark-bg-amber-900-30" style="margin-bottom: 24px; border-top-right-radius: 8px; border-bottom-right-radius: 8px; border-left-width: 4px; border-color: #f59e0b; background-color: #fffbeb; padding: 16px">
        <div style="display: flex">
          <div class="dark-text-amber-400" style="flex-shrink: 0; color: #f59e0b">
            <i class="fas fa-exclamation-triangle fa-lg"></i>
          </div>
          <div style="margin-left: 12px">
            <h3 class="dark-text-amber-300" style="font-size: 14px; font-weight: 500; color: #b45309">
              Your cancellation request was not approved
            </h3>
            <p class="dark-text-amber-300" style="margin-top: 4px; font-size: 14px; color: #b45309">
      ...
      <div class="dark-bg-neutral-700-30" style="margin-bottom: 24px; border-radius: 8px; background-color: #fafafa; padding: 20px">
        <h3 class="dark-text-neutral-100" style="margin-bottom: 16px; font-size: 18px; font-weight: 600; color: #262626">
          <i class="fas fa-info-circle" style="margin-right: 8px; color: #f59e0b"></i> Order Status
        </h3>
        ...
        <div class="space-y-4">
          ...
          <div style="display: flex; align-items: flex-start; margin-top: 16px; margin-bottom: 0">
            ...
            <div style="margin-left: 12px">
              <p class="dark-text-neutral-400" style="font-size: 14px; font-weight: 500; color: #525252">Current Status</p>
              <p class="dark-text-neutral-200" style="color: #262626">Pending</p>
            </div>
          </div>
          ...
          <div style="display: flex; align-items: flex-start; margin-top: 16px; margin-bottom: 0">
            ...
            <div style="margin-left: 12px">
              <p class="dark-text-neutral-400" style="font-size: 14px; font-weight: 500; color: #525252">What Happens Next</p>
      ...
      <div class="sm-grid-cols-2" style="margin-bottom: 24px; display: grid; grid-template-columns: repeat(1, minmax(0, 1fr)); gap: 16px">
        <a href="{{ $orderLink }}" class="hover-bg-amber-700" style="border-radius: 8px; background-color: #d97706; padding: 12px 16px; text-align: center; font-weight: 500; color: #fffffe; transition-property: color, background-color, border-color, text-decoration-color, fill, stroke; transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1); transition-duration: 150ms">
      ...
      <div class="dark-bg-neutral-700-30 dark-border-neutral-700" style="border-radius: 8px; border-width: 1px; border-color: #e5e5e5; background-color: #fafafa; padding: 16px">
        <h4 class="dark-text-neutral-200" style="margin-bottom: 8px; font-weight: 500; color: #262626">
          <i class="fas fa-truck" style="margin-right: 8px; color: #22c55e"></i> Shipping Updates
        </h4>
        <p class="dark-text-neutral-400" style="font-size: 14px; color: #525252">
