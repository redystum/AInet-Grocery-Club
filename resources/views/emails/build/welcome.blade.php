...
<body class="dark-bg-neutral-900" style="background-color: #f5f5f5; font-family: ui-sans-serif, system-ui, -apple-system, 'Segoe UI', sans-serif">
  <div class="dark-bg-neutral-800" style="margin: 32px auto; max-width: 576px; overflow: hidden; border-radius: 12px; background-color: #fffffe; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05)">
    ...
    <div class="from-blue-600 to-purple-600" style="position: relative; background-image: undefined; padding: 24px; text-align: center; color: #fffffe">
      ...
      <h1 style="font-size: 24px; font-weight: 700">Welcome to {{ $appName }}!</h1>
      <p style="margin-top: 4px; opacity: 0.9">We're excited to have you join our community</p>
    </div>
    ...
    <div style="padding: 24px">
      ...
      <div style="margin-bottom: 24px; display: flex; align-items: center">
        ...
        <div>
          ...
          <p class="dark-text-neutral-400" style="color: #525252">Your account has been successfully created</p>
        </div>
      </div>
      ...
      <div class="dark-bg-neutral-700-30" style="margin-bottom: 24px; border-radius: 8px; background-color: #fafafa; padding: 20px">
        <h3 class="dark-text-neutral-100" style="margin-bottom: 16px; font-size: 18px; font-weight: 600; color: #262626">
          <span class="material-symbols-outlined" style="margin-right: 8px; color: #3b82f6">rocket_launch</span> Get Started
        </h3>
        ...
        <div class="space-y-4">
          ...
          <div style="display: flex; align-items: flex-start">
            ...
            <div style="margin-left: 12px">
              <p class="dark-text-neutral-200" style="font-weight: 500; color: #262626">Account created</p>
              <p class="dark-text-neutral-400" style="font-size: 14px; color: #525252">You're all set up!</p>
            </div>
          </div>
          ...
          <div style="display: flex; align-items: flex-start; margin-top: 16px; margin-bottom: 0">
            ...
            <div style="margin-left: 12px">
              <p class="dark-text-neutral-200" style="font-weight: 500; color: #262626">Start exploring</p>
              <p class="dark-text-neutral-400" style="font-size: 14px; color: #525252">Discover all our features</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="sm-grid-cols-2" style="margin-bottom: 24px; display: grid; grid-template-columns: repeat(1, minmax(0, 1fr)); gap: 16px">
        <a href="{{ route(" profile") }}" class="hover-bg-blue-700" style="border-radius: 8px; background-color: #2563eb; padding: 12px 16px; text-align: center; font-weight: 500; color: #fffffe; transition-property: color, background-color, border-color, text-decoration-color, fill, stroke; transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1); transition-duration: 150ms">
          <span class="material-symbols-outlined" style="margin-right: 8px">home</span> Go to your Profile
        </a>
        <a href="{{ route(" home") }}" class="dark-border-neutral-600 hover-bg-neutral-50 dark-hover-bg-neutral-700 dark-text-neutral-200" style="border-radius: 8px; border-width: 1px; border-color: #d4d4d4; padding: 12px 16px; text-align: center; font-weight: 500; color: #404040; transition-property: color, background-color, border-color, text-decoration-color, fill, stroke; transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1); transition-duration: 150ms">
          <span class="material-symbols-outlined" style="margin-right: 8px">play_arrow</span> Start Exploring
        </a>
      </div>
    </div>
