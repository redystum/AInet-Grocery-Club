...
<body class="dark-bg-neutral-900" style="background-color: #f5f5f5; font-family: ui-sans-serif, system-ui, -apple-system, 'Segoe UI', sans-serif">
  <div class="dark-bg-neutral-800" style="margin: 32px auto; max-width: 576px; overflow: hidden; border-radius: 12px; background-color: #fffffe; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05)">
    ...
    <div class="from-green-600 to-emerald-600" style="position: relative; background-image: undefined; padding: 24px; text-align: center; color: #fffffe">
      ...
      <h1 style="font-size: 24px; font-weight: 700">Your Order Has Been Placed!</h1>
      <p style="margin-top: 4px; opacity: 0.9">Order #{{ $orderId }} is being processed</p>
    </div>

    <div style="padding: 24px">
      <!-- Stock Delay Warning -->
      @if($delayed)
      <div class="dark-bg-yellow-900-30" style="margin-bottom: 24px; border-top-right-radius: 8px; border-bottom-right-radius: 8px; border-left-width: 4px; border-color: #eab308; background-color: #fefce8; padding: 16px">
        <div style="display: flex">
          <div class="dark-text-yellow-400" style="flex-shrink: 0; color: #eab308">
            <i class="fas fa-exclamation-circle fa-lg"></i>
          </div>
          <div style="margin-left: 12px">
            <h3 class="dark-text-yellow-300" style="font-size: 14px; font-weight: 500; color: #a16207">
              Potential Delivery Delay
            </h3>
            <p class="dark-text-yellow-300" style="margin-top: 4px; font-size: 14px; color: #a16207">
              Some items in your order may be delayed due to stock availability. We'll keep you updated.
            </p>
          </div>
        </div>
      </div>
      ...
      <div style="margin-bottom: 24px; display: flex; align-items: center">
        ...
        <div>
          ...
          <p class="dark-text-neutral-400" style="color: #525252">Thank you for your order! We're preparing your items for shipment.</p>
        </div>
      </div>
