...
@section('content')
    <div class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <!-- Restock Form -->
        <form id="restockForm" method="POST" action="{{ route('board.restock.store') }}">
            @csrf
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
                        ...
                        @forelse($products as $product)
                            <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-700/50 transition-colors restock-item"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center w-fit border border-neutral-300 dark:border-neutral-600 rounded-lg overflow-hidden bg-white dark:bg-neutral-700">
                                        <button type="button"
                                                class="quantity-minus px-3 py-2 h-full text-neutral-600 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-600">
                                        ...
                                        <button type="button"
                                                class="quantity-plus px-3 py-2 h-full text-neutral-600 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-600">
                                ...
                                @if($product->alreadySupplyOrder != null && $product->alreadySupplyOrder == true)
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-red-600 dark:text-red-400">
                                            <i class="fas fa-exclamation-triangle mr-1"></i> Already exists a supply
                                            order
                                        </div>
                                    </td>
                                @else
                ...
                <div class="p-4 border-t border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-700/30">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div class="text-neutral-700 dark:text-neutral-300">
                            <p><span class="font-medium" id="itemCount">{{ count($products) }} items</span> selected for
                                restocking</p>
                            <p class="text-sm">Total unit items: <span
