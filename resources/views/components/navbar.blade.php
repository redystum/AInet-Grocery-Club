            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <button id="cartButton" type="button"
                        class="relative bg-yellow-400 hover:bg-yellow-500 text-neutral-900 p-2 rounded-full transition-colors focus:outline-none shadow">
                        <i class="fas fa-shopping-cart"></i>
                        <span id="cartCount"
                            class="absolute -top-2 -right-2 bg-red-600 text-xs rounded-full px-2 py-0.5 font-bold">0</span>
                    </button>
                </div>
                <!-- User dropdown -->
