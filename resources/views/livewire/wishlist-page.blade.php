                ...
                <div class="product-container">
                    <a href="{{ route('product.show', $product->id) }}"
                       class="product-card bg-white dark:bg-neutral-800 rounded-xl shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md relative group block">
                        <!-- Wishlist Button -->
                        <button
                                class="absolute top-3 right-3 z-10 w-8 h-8 bg-white dark:bg-neutral-700 rounded-full flex items-center justify-center shadow-md hover:bg-neutral-100 dark:hover:bg-neutral-600 transition-colors opacity-100 cursor-pointer"
                                wire:click.stop.prevent="removeFromWishlist({{ $product->id }})">
                            <i class="fas fa-heart text-neutral-600 dark:text-neutral-300"></i>
                        </button>
                        ...
                        <div class="p-5">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <button type="button"
                                        onclick="event.preventDefault(); event.stopPropagation(); quickAddToCart({{ $product->id }}, event)"
